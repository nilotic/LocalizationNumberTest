//
//  CurrencyResultsViewController.swift
//  LocalizationTest
//
...
final class CurrencyResultsViewController: UIViewController {
    ...
    // MARK: - Value
    // MARK: Public
    let dataManager = CurrencyResultsDataManager()
...
// MARK: - UITableView
// MARK: DataSource
extension CurrencyResultsViewController: UITableViewDataSource {
...
// MARK: Delegate
extension CurrencyResultsViewController: UITableViewDelegate {
